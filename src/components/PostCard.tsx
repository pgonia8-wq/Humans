...
const App = () => {
  const { setUsername: setGlobalUsername, setAvatar: setGlobalAvatar } = useContext(ThemeContext);
  ...
  // Obtener wallet usando walletAuth y username/avatar de MiniKit.user
  useEffect(() => {
    const loadWallet = async () => {
      ...
      try {
        ...
        // Obtener username y avatar desde MiniKit.user **solo después de walletAuth**
        if (MiniKit.user) {
    ...
    loadWallet();
  }, [verified, wallet, verifying, miniKitReady, setGlobalUsername, setGlobalAvatar]);
