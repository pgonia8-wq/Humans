...
const FeedPage: React.FC<FeedPageProps> = ({
  ...
  useEffect(() => {
    ...
    const fetchPriceAndSlots = async () => {
      ...
      if (error) {
        console.error("[UPGRADE] slots error:", error);
        return;
      }
  ...
  const confirmUpgrade = async () => {
    ...
    console.log("[UPGRADE] Iniciando pago:", selectedTier, price);
    ...
    try {
      ...
      console.log("[UPGRADE] tx:", transactionId);
            ...
            <ul className="text-gray-200 mb-6 list-disc list-inside space-y-2">
              ...
              {selectedTier === "premium" && (
                <>
                  ...
                  <li>Slots restantes {slotsLeft}</li>
                </>
              )}
        ...
        <div className="fixed inset-0 z-60 flex items-center justify-center bg-black/70">
          ...
          <div className="bg-gray-900 rounded-2xl p-8 w-full max-w-sm border border-white/10 text-center">
            ...
            <p className="text-gray-300 mb-6">
              No tienes suficientes WLD para completar el upgrade.
            </p>
